...
setMethod("normalize", "ExampleClass", function(object) {
    ...
    set_props(object, rowVec=new.row, 
        colVec=new.col, check=FALSE)
})
```

We use `set_props` instead of the setter methods
...
alter the validity of the object.  The `set_props` function allows
...
setMethod("[", "ExampleClass", function(x, i, j, drop=TRUE) {
    ...
    out <- callNextMethod()
    set_props(out, rowVec=rv, colVec=cv,
